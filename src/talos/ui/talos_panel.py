...
from talos.bridge.protocol import BridgeRequest
...
from talos.ui.bridge_controller import GuiBridgeController, get_or_start_gui_bridge
...
def mcp_configuration() -> dict[str, object]:
    ...
    legacy = scripts / "talos-freecad-mcp.exe"
