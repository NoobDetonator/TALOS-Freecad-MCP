...
from talos.bridge.protocol import PROTOCOL_VERSION
from talos.bridge.transport import BridgeEndpoint
...
def default_session_store() -> BridgeSessionStore:
    runtime_directory = os.environ.get("TALOS_RUNTIME_DIR")
    if runtime_directory:
        return BridgeSessionStore(runtime_directory)
    return BridgeSessionStore(user_runtime_dir("talos-freecad-mcp", appauthor=False))
