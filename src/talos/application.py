...
from talos.core.partdesign_registry import PARTDESIGN_FEATURES
from talos.core.tool_registry import ToolRegistry, build_default_registry
...
class CadAdapter(Protocol):
    ...
    def new_document(self, name: str = "TalosDoc") -> dict[str, Any]: ...
