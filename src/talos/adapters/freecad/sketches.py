...
class SketchMixin:
    ...
    def create_empty_sketch(
        ...
        def create(document: Any) -> None:
            ...
            sketch.addProperty("App::PropertyString", "TalosPlane", "Sketch")
            sketch.TalosPlane = checked_plane
            sketch.addProperty("App::PropertyLength", "TalosPlaneOffset", "Sketch")
            sketch.TalosPlaneOffset = checked_offset
            return None
