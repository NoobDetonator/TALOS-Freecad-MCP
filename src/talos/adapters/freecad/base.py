...
from talos.core.context import ContextStateTracker
...
class FreeCadAdapterBase:
    ...
    def _derived_feature(
        ...
        result.Shape = shape
        result.addProperty("App::PropertyLinkList", "SourceObjects", "TALOS")
        result.SourceObjects = list(sources)
        result.addProperty("App::PropertyString", "FeatureKind", "TALOS")
